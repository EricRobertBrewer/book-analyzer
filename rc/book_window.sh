...
do
    ...
    then
        model_file_names=("36263810_0.h5" "36263811_1.h5" "36263812_2.h5" "36263813_3.h5" "36263814_4.h5" "36263815_5.h5" "36263816_6.h5" "36263817_7.h5")
    else  # [[ $i == 2 ]]
        model_file_names=("36263819_0.h5" "36263820_1.h5" "36263821_2.h5" "36263822_3.h5" "36263823_4.h5" "36263824_5.h5" "36263825_6.h5" "36263826_7.h5")
    fi
    for j in {0..7}
    do
        for size in "1" "3" "5" "7"
        do
            ...
            py="python3 -m python.classifiers.book_net_window ${classifier_names[i]} ${model_file_names[j]} ${size}"
            echo $py >> $f
